...
// Prof. Vanselow
// A combination of everything I learned in COP 2006
// A calculator that can be used when working out
...
public class Main {
  ...
  public static void main(String[] args) {
    System.out.println("Welcome to the Workout Calculator!");
    boolean likeToWorkout = false;
    final double KM_IN_MILE;
    KM_IN_MILE = 1.61;
    //kmInMile = 1.24;
    System.out.println("I like to workout is a " + likeToWorkout + " statement.");
